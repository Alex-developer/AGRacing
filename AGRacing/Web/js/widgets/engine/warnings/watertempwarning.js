var AGRacingWATERTEMPWARNINGWidget = function () {
    'use strict';

    var _name = 'Water Temp';
    var _icon = '/images/widgets/damage.png';
    var _labels = ['Water temp Warning'];
    var _tab = 'Engine';
    ...
    var _el = null;
    var _elId = null;
    var _lastWaterTempWarning = null;

    var _properties = {
        type: 'watertempwarning',
        css: {
            left: 0,
            top: 0,
            width: 150,
    ...
    function buildUI() {
        ...
        var element = jQuery('<span>').css({ 'pointer-events': 'none' }).text('Water Temp').attr('id', _elId);
    ...
    function updateUI(data) {
        if (_initialised) {
            if (_lastWaterTempWarning !== data.Engine.WaterTempWarning) {
                if (data.Engine.WaterTempWarning) {
                ...
                _lastWaterTempWarning = data.Engine.WaterTempWarning;
            }
        }
    }
...
//# sourceURL=/js/widgets/engine/warnings/watertempwarning.js