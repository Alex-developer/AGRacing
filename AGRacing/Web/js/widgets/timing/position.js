var AGRacingPOSITIONWidget = function () {
    'use strict';

    var _name = 'Position';
    var _icon = '/images/widgets/position.png';
    var _labels = ['Position'];
    var _tab = 'Timing';
            ...
            for (var i = 0 ; i < drivers.length; i++) {
                if (drivers[i].IsCurrentDriver) {
                    ...
                    if (drivers[i].Position == -1) {
                        ...
                        position = drivers[i].Position + ' / ' + drivers.length;
                    }
                    if (_lastPosition !== position) {
                        jQuery('#' + _elId).text(position);
...
//# sourceURL=/js/widgets/timing/position.js