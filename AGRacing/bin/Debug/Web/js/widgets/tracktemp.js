var AGRacingTRACKTEMPWidget = function () {
    'use strict';

    var _name = 'Track';
    var _icon = '/images/widgets/temperature.png';
    var _labels = ['Track Temperature', 'Track Temp.', 'Track'];

    var _initialised = false;
    var _el = null;
    var _elId = null;
    var _lastTrackTemp = null;
    ...
    function updateUI(data) {
        if (_initialised) {
            var trackTemp = data.TrackTemperature.toFixed(1);
            if (_lastTrackTemp !== trackTemp) {
                jQuery('#' + _elId).html(trackTemp + ' &deg;C');
                _lastTrackTemp = trackTemp;
            }
        }
    }
...
//# sourceURL=/js/widgets/tracktemp.js